    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
		...
		<?php
				...
				$query=mysqli_query($con,"select * from time where days='smt' order by time_start")or die(mysqli_error());
		...
		<div class="col-md-6">
			...
			<?php
					include('../dist/includes/dbcon.php');
					$query=mysqli_query($con,"select * from time where days='wth' order by time_start")or die(mysqli_error());
					 ...
					 <div class="col-md-12">
						  ...
						  <div class="form-group">
							<label for="date">Remarks</label><br>
								<textarea name="remarks" cols="30" placeholder="Why you need this room?"></textarea>
